...
async function on(t, e) {
  ...
  }, o = e ? e(s) : s, a = sn() ? r.body : await r.blob();
...
class dn {
  ...
  handleAll(e) {
    ...
    const n = e.event, r = typeof e.request == "string" ? new Request(e.request) : e.request, s = "params" in e ? e.params : void 0, o = new hn(this, { event: n, request: r, params: s }), a = this._getResponse(o, r, n), i = this._awaitComplete(a, o, r, n);
    return [a, i];
  }
...
class fn {
  ...
  addToCacheList(e) {
    ...
    for (const r of e) {
      ...
      const { cacheKey: s, url: o } = Qt(r), a = typeof r != "string" && r.revision ? "reload" : "default";
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  install(e) {
    return Me(e, async () => {
      ...
      return {}.NODE_ENV !== "production" && rn(r, s), { updatedURLs: r, notUpdatedURLs: s };
    });
  }
  /**
  ...
  activate(e) {
    return Me(e, async () => {
      ...
      return {}.NODE_ENV !== "production" && nn(o), { deletedURLs: o };
    });
  }
  /**
...
class F {
  ...
  constructor(e, n, r = nt) {
    ({}).NODE_ENV !== "production" && (b.isType(e, "function", {
      ...
      funcName: "constructor",
      paramName: "match"
    }), r && b.isOneOf(r, pn, { paramName: "method" })), this.handler = K(n), this.match = e, this.method = r;
  }
  /**
   *
   * @param {workbox-routing-handlerCallback} handler A callback
...
function* En(t, { ignoreURLParametersMatching: e = [/^utm_/, /^fbclid$/], directoryIndex: n = "index.html", cleanURLs: r = !0, urlManipulation: s } = {}) {
  const o = new URL(t, location.href);
  o.hash = "", yield o.href;
  const a = yn(o, e);
...
class X {
  ...
  create(e, ...n) {
    const r = n[0] || {}, s = `${this.service}/${e}`, o = this.errors[e], a = o ? Vn(o, r) : "Error", i = `${this.serviceName}: ${a} (${s}).`;
    return new B(s, i, r);
  }
}
function Vn(t, e) {
...
const or = ["get", "getKey", "getAll", "getAllKeys", "count"], ar = ["put", "add", "delete", "clear"], ce = /* @__PURE__ */ new Map();
function qe(t, e) {
  if (!(t instanceof IDBDatabase && !(e in t) && typeof e == "string"))
    return;
  if (ce.get(e))
    return ce.get(e);
  const n = e.replace(/FromIndex$/, ""), r = e !== n, s = ar.includes(n);
  if (
...
const be = "@firebase/app", Ke = "0.10.11";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ur = "firebase-heartbeat-database", Vr = 1, j = "firebase-heartbeat-store";
let ue = null;
function ft() {
 ...
 * limitations under the License.
 */
const jr = 1024, Hr = 30 * 24 * 60 * 60 * 1e3;
class qr {
  constructor(e) {
...
async function Fs(t) {
  ...
  })).close(), await ie(de), await ie("fcm_vapid_details_db"), await ie("undefined"), js(e) ? e : null;
}
function js(t) {
...
async function De(t) {
  ...
  if (r)
    return r;
  {
    const s = await Fs(t.appConfig.senderId);
    if (s)
...
function co(t, e, n) {
  const r = {};
  r.event_time_ms = Math.floor(Date.now()).toString(), r.source_extension_json_proto3 = JSON.stringify(e), n && (r.compliance_data = uo(n)), t.logEvents.push(r);
}
function uo(t) {
  return {
    privacy_context: {
...
async function ho(t, e) {
  ...
  if (wo(r))
    return bo(r, n);
  if (n.notification && await yo(po(n)), !!e && e.onBackgroundMessageHandler) {
    const s = eo(n);
 ...
 */
const Co = (t) => {
  const e = new vo(t.getProvider("app").getImmediate(), t.getProvider("installations-internal").getImmediate(), t.getProvider("analytics-internal"));
 ...
 */
To();
Rn([{"revision":null,"url":"assets/Harbor-6a6d3ad8.js"},{"revision":null,"url":"assets/index-84aed4d5.css"},{"revision":null,"url":"assets/Kafka-ad3df052.js"},{"revision":null,"url":"assets/Kibana-caf6d285.js"},{"revision":null,"url":"assets/Kubernetes-37b39866.js"},{"revision":"9577065d2bd55a2a8c541b458b79fc6e","url":"index.html"},{"revision":"615154b21d18141b388b64d08da82118","url":"manifest.webmanifest"}]);
In();
const Do = {
  ...
  if (t.request.url.includes("&X-Amz-Expires")) {
    ...
    s || (s = new Request(t.request)), t.respondWith(
      fetch(s, { mode: "cors", credentials: "same-origin" }).then(async (o) => {
        const i = new URL(t.request.url).pathname.slice(1).split("/")[1], c = await Ut("s3", 1, ["s3", "aes"]), h = await Lo(c, "aes", "key-" + decodeURIComponent(i), "readwrite", "");
          ...
          return o;
        {
          ...
          async function Le() {
            const te = w.subarray(0, E), ne = await $o(te, h, decodeURIComponent(i), "AES-GCM");
            l = Oo(l, new Uint8Array(ne)), w.fill(0), E = 0;
          }
          let L = new Headers();
...
async function $o(t, e, n, r) {
  ...
  try {
    ...
    return await Po(c, "aes", "key-" + n, "readwrite"), new Uint8Array(0);
  }
  return a;
}
function Ut(t, e, n) {
